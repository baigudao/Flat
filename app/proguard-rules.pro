...
#}
    ...
    #-------------------------------------------定制化区域----------------------------------------------
    #---------------------------------1.实体类---------------------------------
    -keep class com.taisau.msghandler.** {*;}#消息实体类和管理类
    #-------------------------------------------------------------------------
    #---------------------------------2.第三方包-------------------------------
    #H 版算法
    -keep class com.mv.face.recognize.** {*;}
    -keep class com.mv.face.auth.**{*;}
    -keep class com.mv.face.livebody.**{*;}
    #封装的广域网协议
     -keep class com.taisau.signalrandroidsdk.**{*;}#暴露的接口类不混淆
...
#    -keep class org.junit.** {*;}
   ...
   # -dontwarn android.backport.webp.**
    ...
    #-keep class org.xutils.**{*;}
     #model
    -keep interface flat.http.*{*;}
    -keep class flat.http.*{*;}
    -keep public class flat.model.*{*;}
