package com.taisau.flat.widget;
...
//            canvas.drawRect(getMeasuredWidth() - 4, 0, getMeasuredWidth(), getMeasuredHeight(), mPaint);
            rect1.set(0, 0, getMeasuredWidth(), 4);//上边框
            canvas.drawRoundRect(rect1, 2, 2, mPaint);
            rect2.set(0, 0, 4, getMeasuredHeight());//左边框
            canvas.drawRoundRect(rect2, 2, 2, mPaint);
            rect3.set(0, getMeasuredHeight() - 4, getMeasuredWidth(), getMeasuredHeight());//下边框
            canvas.drawRoundRect(rect3, 2, 2, mPaint);
            rect4.set(getMeasuredWidth() - 4, 0, getMeasuredWidth(), getMeasuredHeight());//右边框
    ...
    public void createFrame(FrameLayout faceFrame, long[] position, int pic_width, int pic_height) {
        ...
        params.setMargins((/*pic_width - */(int) position[0]) * frameWidth / pic_width, (int) position[1] * frameHeight / pic_height, 0, 0);
