...
public class Preference {
    ...
    //比对服务器的分组，多个
    private static final String GFSGROUPIdS = "GfsGroupIds ";
    /**后台比对的地址*/
    private static final String COMPARE_SERVER_URL = "compare_server_url";
    ...
    public static String[] getGFSGROUPIdS() {
        return getStringSet(GFSGROUPIdS);
    }

    public static void setGFSGROUPIdS(String[] gfsgroupIdS) {
        saveStringSet(GFSGROUPIdS, gfsgroupIdS);
    }
    public static String getCompareServerUrl() {
        return getString(COMPARE_SERVER_URL);
    }
    public static void setCompareServerUrl(String url){
        saveString(COMPARE_SERVER_URL,url);
    }
    ...
    private static String[] getStringSet(String key) {
        Set<String> strings = getSharedPreference().getStringSet(key, new HashSet<>());
        return strings.toArray(new String[strings.size()]);
    }

    private static void saveStringSet(String key, String[] values) {
        SharedPreferences.Editor editor = getSharedPreference().edit();
    ...
    static SharedPreferences getSharedPreference() {
        return FlatApplication.getApplication().getSharedPreferences("Door_Setting_Info", Context.MODE_PRIVATE);
    }
}
