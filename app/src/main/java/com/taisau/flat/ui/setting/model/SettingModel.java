package com.taisau.flat.ui.setting.model;
...
//        deleteFile(whiteFile);
            deleteFile(file);
            FlatApplication.getApplication().getDaoSession().getHistoryDao().deleteAll();
            FlatApplication.getApplication().getDaoSession().getPersonDao().deleteAll();
    ...
    private void deleteFile(File[] fileList) {
        ...
        FileUtils.updateFileToSystem(FlatApplication.getApplication(), fileNames, null);
    }
}
