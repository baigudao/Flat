...
import com.taisau.flat.BuildConfig;
...
//
//        }
        s.append(0, Preference.getServerIp());
        s.append(1, Preference.getServerPort());
        s.append(2, Preference.getGateIp());
        s.append(3, Preference.getGatePort());
        s.append(4, BuildConfig.VERSION_NAME);
        return s;
    }
