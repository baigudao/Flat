package com.taisau.flat.ui.personlist.adpter;
...
import com.taisau.flat.widget.GlideCircleTransform;
...
//            List<FaceList> fl = FlatApplication.getApplication().getDaoSession().getFaceListDao().queryBuilder().where(FaceListDao.Properties.PersonId.eq(person.getPerson_id())).list();
//            if (fl.size() > 0)
