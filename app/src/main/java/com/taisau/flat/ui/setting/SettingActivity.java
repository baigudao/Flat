package com.taisau.flat.ui.setting;
...
import com.taisau.flat.ui.setting.compare.CompareSettingActivity;
import com.taisau.flat.ui.setting.device.DeviceSettingActivity;
import com.taisau.flat.ui.setting.display.DisplaySettingActivity;
import com.taisau.flat.ui.setting.listener.OnDownLoadListener;
import com.taisau.flat.ui.setting.network.NetworkSettingActivity;
import com.taisau.flat.ui.setting.presenter.SettingPresenter;
...
public class SettingActivity extends BaseActivity implements View.OnClickListener, ISettingView {
    ...
    /*    Uri packageURI = Uri.parse("package:com.taisau.flat");
        ...
        //    ShellUtils.execCommand("pm install -r mnt/internal_sd/caffe_mobile/FaceCompare.apk",false);
           /* Runtime.getRuntime().exec("sh");
            Runtime.getRuntime().exec("pm uninstall com.taisau.flat");
