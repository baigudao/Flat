package com.taisau.flat.ui.personlist;
...
import com.taisau.flat.ui.personlist.adpter.PersonListAdapter;
...
public class PersonListActivity extends BaseActivity {
    ...
    public void initData() {
        Observable.create(e -> {
            dataList = FlatApplication.getApplication().getDaoSession().getPersonDao().loadAll();
            if (dataList.size() <= 20) {
    ...
    public void doSearch(String search_content) {
        Observable.create(e -> {
            QueryBuilder<Person> builderB = FlatApplication.getApplication().getDaoSession().getPersonDao().queryBuilder();
