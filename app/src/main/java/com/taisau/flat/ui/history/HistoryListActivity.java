package com.taisau.flat.ui.history;
...
import com.taisau.flat.ui.history.adpter.HistoryAdapter;
...
public class HistoryListActivity extends BaseActivity {
    ...
    public void initData() {
        ThreadPoolUtils.execute(() -> {
            dataList = FlatApplication.getApplication().getDaoSession().getHistoryDao().queryBuilder().orderDesc(HistoryDao.Properties.Time).list();
            if (dataList.size() <= 20) {
    ...
    public void doSearch(String search_content) {
        QueryBuilder builder1 = FlatApplication.getApplication().getDaoSession().getHistoryDao().queryBuilder();
