...
public class Person {
    ...
    public String getIndexImgPath(int index) {
        switch (index) {
            case 0:
                return getImg_path();
            case 1:
                return getPush_img_path1();
            case 2:
                return getPush_img_path2();
            case 3:
                return getPush_img_path3();
            default:
                return getImg_path();
        }
    }

    public String getIndexFeaPath(int index) {
        switch (index) {
            case 0:
                return getFea_path();
            case 1:
                return getPush_fea_path1();
            case 2:
                return getPush_fea_path2();
            case 3:
                return getPush_fea_path3();
            default:
                return getFea_path();
        }
    }

    public void setIndexImgPath(int index, String path) {
        switch (index) {
            case 0:
                setImg_path(path);
            case 1:
                setPush_img_path1(path);
            case 2:
                setPush_img_path2(path);
            case 3:
                setPush_img_path3(path);
            default:
        }
    }

    public void setIndexFeaPath(int index, String path) {
        switch (index) {
            case 0:
                setFea_path(path);
            case 1:
                setPush_fea_path1(path);
            case 2:
                setPush_fea_path2(path);
            case 3:
                setPush_fea_path3(path);
            default:
        }
    }
